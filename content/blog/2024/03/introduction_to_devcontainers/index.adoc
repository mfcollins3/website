...
image::reopen_in_vscode.gif[Video showing reopening a workspace inside of a Devcontainer in Visual Studio Code,640,480,link=reopen_in_vscode.gif]
...
image::devcontainer.png[Visual Studio Code running inside of a Devcontainer]
...
image::clone_to_devcontainer.gif[Video showing cloning a repository containing a Devcontainer and building it in Visual Studio Code,640,480,link=clone_to_devcontainer.gif]
